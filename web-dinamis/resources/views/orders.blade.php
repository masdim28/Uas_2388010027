    ...
    <nav class="bg-[#FAF8F5] shadow-sm border-b border-gray-100 py-4">
        <div class="max-w-6xl mx-auto px-4 flex justify-between items-center">
            ...
            <div class="flex items-center gap-4">
                <a href="{{ route('home') }}"
                    class="text-sm font-semibold text-gray-600 hover:text-[#CFB53B]">Beranda</a>
    ...
    <main class="max-w-6xl mx-auto py-10 px-4 w-full flex-grow">
        ...
        <div class="flex border-b border-gray-200 mb-6 overflow-x-auto no-scrollbar">
            <button onclick="switchTab('unpaid')" id="tab-unpaid"
                class="tab-active py-3 px-6 whitespace-nowrap outline-none transition-colors text-sm">
                Belum Dibayar ({{ $unpaidOrders->count() }})
            </button>
            <button onclick="switchTab('processing')" id="tab-processing"
                class="tab-inactive py-3 px-6 whitespace-nowrap outline-none transition-colors text-sm">
                Sedang Dikemas ({{ $processingOrders->count() }})
            </button>
            <button onclick="switchTab('shipping')" id="tab-shipping"
                class="tab-inactive py-3 px-6 whitespace-nowrap outline-none transition-colors text-sm">

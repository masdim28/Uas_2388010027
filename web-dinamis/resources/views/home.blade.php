...
<head>
    ...
    <style>
        ...
        #search-box { transition: all 0.3s ease-in-out; }
    </style>
</head>
<body class="bg-ade-green text-gray-900 overflow-x-hidden">
    ...
    <nav class="bg-ade-krem shadow-sm sticky top-0 z-50 border-b border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div id="search-box" class="hidden border-t border-gray-50 py-4 px-4 bg-white/50 backdrop-blur-sm transition-all duration-300">
                <form action="{{ route('products.index') }}" method="GET" x-data="searchProducts()" class="flex items-center max-w-4xl mx-auto border-2 border-[#CFB53B] rounded-full p-1.5 bg-white relative shadow-sm">
                    ...
                    <input 
                        ...
                        placeholder="Cari produk (misal: Gamis)..." 
                    ...
                    <div x-show="open && query.length >= 2" 
                        ...
                        <template x-for="product in results" :key="product.id">
                            <a :href="'/products/' + product.id" class="flex items-center gap-4 p-3 hover:bg-[#F1FBFD] transition-all group">
                                <img :src="'/storage/' + product.image" :alt="product.name" class="w-9 h-9 object-cover rounded-lg border">
                                <div class="flex-1">
                                    <h4 class="text-xs font-medium text-gray-800 group-hover:text-[#CFB53B] transition" x-text="product.name"></h4>
                        ...
                        <div x-show="results.length === 0 && query.length >= 2" class="p-4 text-center text-xs text-gray-400 italic">
    ...
    <a href="https://api.whatsapp.com/send?phone=087739877969&text=Halo%20Admin,%20saya%20ingin%20bertanya%20mengenai%20produk%20di%20Ade%20Afwa%20Boutique" 
       target="_blank" 
